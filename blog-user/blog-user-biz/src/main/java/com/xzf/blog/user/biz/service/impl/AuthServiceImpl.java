...
import com.xzf.blog.framework.commons.sms.AliyunSmsHelper;
...
import com.xzf.blog.user.dto.req.UpdateUserPasswordRequest;
...
public class AuthServiceImpl implements AuthService {
    ...
    public Response<?> updatePassword(UpdatePasswordReqVO updatePasswordReqVO) {
        ...
        //更新密码
        userService.updatePassword(UpdateUserPasswordRequest.builder().encodePassword(encodePassword).build());
